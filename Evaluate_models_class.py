...
reg_methods = ['LogisiticRegression', 'RidgeClassifier', 'BaggingClassifier', 
...
regress_list = [LogisticRegression(fit_intercept = SET_FIT_INTERCEPT),                
               RidgeClassifier(alpha = 1, solver = 'cholesky', 
...
#               XGBClassifier(objective="reg:logistic", random_state=RANDOM_SEED)
                ]
